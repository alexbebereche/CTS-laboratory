...
public class DbConnection {
	...
	// version 1 - eager approach; dont want for anyone to ask for it,create when its loaded
//	private static DbConnection dbConnection = new DbConnection();
	...
	// uses the class lazy-loading approach - the class will be loaded only when we need it
	static {
